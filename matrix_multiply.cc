...
// 256 (256/16 = 16, 0.01193838276s) (256/8 = 32, 0.01371627267s)->1.047494s
// 128 (128/16 = 8 , 0.00180587449s) (128/8 = 16, 0.00189148828s)->0.626098s
...
void Workload::GPU_Worker() {
  ...
  while (!stop) {
    ...
    // Max work item sizes: 256x256x256, Max work group size: 256

    queue.enqueueNDRangeKernel(kernel, cl::NullRange,
                               cl::NDRange(GPU_MAT_SIZE, GPU_MAT_SIZE),
                               cl::NDRange(8, 8), NULL, event);
    // queue.enqueueNDRangeKernel(kernel, cl::NullRange,
    //                            cl::NDRange(GPU_MAT_SIZE, GPU_MAT_SIZE),
    //                            cl::NullRange);
    // queue.flush();
  ...
  if (idx == GPU_MAT_SIZE) printf("Verification success!\n");
